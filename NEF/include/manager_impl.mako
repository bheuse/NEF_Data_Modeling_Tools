...
import com.openet.modules.nef.${servicePackageName}.service.api.beans.DatastoreApiBeans.*;
...
import com.openet.${managerPackagerName}.api.${managerName};
...
\n
@ProviderEnabledComponent(configurationPid = "${managerName}", componentType = ProviderEnabledComponentType.COMPONENT)
public class ${managerName}Impl implements ${managerName} {
\n
...
\n
    ...
    private ${managerName}Config config;
\n
    @ProviderActivate
